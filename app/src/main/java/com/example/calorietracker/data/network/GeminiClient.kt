        ...
        val generativeModel = GenerativeModel(
            ...
            systemInstruction = com.google.ai.client.generativeai.type.content {
                text("You are a precise nutrition API and a natural language translator for the FDA database. The user will provide a meal description.\n" +
                     ...
                     "Rule 3: You MUST carefully compensate for any weird or specific portion sizes specified by the user (e.g. 'half a cup', '3 pounds', '2 bites', '1 stack of ritz fresh stacks'). Do NOT assume a standard serving size if the user specifies otherwise. Your 'estimated_macros' and 'total_calories' must accurately reflect the exact portion size requested. If a specific package or brand portion is mentioned, use its known nutritional value directly (e.g. 1 stack of Ritz Fresh Stacks is ~220 kcal).\n" +
